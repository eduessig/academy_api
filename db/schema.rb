...
ActiveRecord::Schema[7.2].define(version: 2025_11_13_234923) do
  ...
  create_table "physical_reviews", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "cpf", null: false
    t.date "birth_date"
    t.bigint "personal_trainer_id"
    t.json "tokens"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["confirmation_token"], name: "index_users_on_confirmation_token", unique: true
    t.index ["email"], name: "index_users_on_email", unique: true
    t.index ["personal_trainer_id"], name: "index_users_on_personal_trainer_id"
  ...
  add_foreign_key "physical_reviews", "users"
